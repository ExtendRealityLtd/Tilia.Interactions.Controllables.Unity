namespace Tilia.Interactions.Controllables.AngularDriver
{
    ...
    public abstract class AngularDrive : Drive<AngularDriveFacade, AngularDrive>
    {
        ...
        /// <summary>
        /// The normalized threshold rotation of the drive.
        /// </summary>
        protected virtual float ThresholdRotation => (DriveLimits.maximum - DriveLimits.minimum) * TargetValueReachedThreshold;
        ...
        protected virtual float CalculateAutoDriveVelocity()
        {
            return (Facade.MoveToTargetValue
                && !currentPseudoRotation.ApproxEquals(ActualTargetAngle, ThresholdRotation) ? Facade.DriveSpeed : 0f) * CalculateDirectionMultiplier();
        }
